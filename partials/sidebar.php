 <div id="sidebar" class="z-20 fixed top-0 left-0 w-50 h-full footer-grey-bg flex flex-col p-4 -translate-x-full transition-transform duration-300 justify-between">
     <nav class="w-full h-auto flex flex-col gap-4">
         ...
         <a aria-label="Aller au paramètres" href="home.php" class="group">
             <div class="group flex flex-row gap-4 items-center">
                 <svg class="w-8 h-auto fill-white hover-fill-green" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                     <path d="M11.336 2.253a1 1 0 0 1 1.328 0l9 8a1 1 0 0 1-1.328 1.494L20 11.45V19a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2v-7.55l-.336.297a1 1 0 0 1-1.328-1.494l9-8zM6 9.67V19h3v-5a1 1 0 0 1 1-1h4a1 1 0 0 1 1 1v5h3V9.671l-6-5.333l-6 5.333zM13 19v-4h-2v4h2z" />
                 </svg>
                 <p class="font-main text-white hover-green">Accueil</p>
             </div>
         </a>

         <a aria-label="Chercher une track" href="search.php" class="group">
             <div class="group flex flex-row gap-4 items-center">
                 <svg class="w-8 h-auto fill-white hover-fill-green" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
         ...
         <a aria-label="Importer une track" href="import-track.php" class="group">
             <div class="group flex flex-row gap-4 items-center">
                 <svg class="w-8 h-auto fill-white hover-fill-green" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1024 1024">
         ...
         <a aria-label="Consulter ta librairie" href="library.php" class="group">
             <div class="group flex flex-row gap-4 items-center">
                 <svg class="w-8 h-auto fill-white hover-fill-green" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256">
                 ...
                 <p class="font-main text-white focus-green-child hover-green">Librairie</p>
             </div>
         </a>


         <a aria-label="Aller au paramètres" href="#" class="group">
             <div class="group flex flex-row gap-4 items-center">
                 <svg class="w-8 h-auto fill-white hover-fill-green " fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1024 1024">
                 ...
                 <p class="font-main text-white hover-green">Paramètres</p>
             </div>
         </a>
     </nav>
